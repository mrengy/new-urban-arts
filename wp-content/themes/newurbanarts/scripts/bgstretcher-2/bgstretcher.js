...
(function($){
	...
	$.fn.bgStretcher = function(settings){
		...
		function _build(body_content){
			...
			if(settings.slideShow && $(allLIs).length > 1){
				_bgStretcherTm = setTimeout('$b.fn.bgStretcher.slideShow(\''+$.fn.bgStretcher.settings.sequenceMode+'\', -1)', settings.nextSlideDelay);
			}
	...
	$.fn.bgStretcher.slideShow = function(sequence_mode, index_next){	
		...
		if(!_bgStretcherPause){
		  _bgStretcherTm = setTimeout('$b.fn.bgStretcher.slideShow(\''+$.fn.bgStretcher.settings.sequenceMode+'\', -1)', $.fn.bgStretcher.settings.nextSlideDelay);
		}
	};
